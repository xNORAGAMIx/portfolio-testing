...
import { SiJavascript, SiMysql, SiTailwindcss, SiSolidity, SiFirebase } from "react-icons/si";

const skills = [
  { icon: <FaReact size={30} />, label: "React.js" },
  { icon: <FaNodeJs size={30} />, label: "Node.js" },
  { icon: <FaJava size={30} />, label: "Java" },
  { icon: <SiJavascript size={30} />, label: "JavaScript" },
  ...
  { icon: <SiSolidity size={30} />, label: "Solidity" },
  { icon: <SiFirebase size={30} />, label: "Firebase" },
];
    ...
    <section id="skills" className="py-20 px-6 md:px-20 bg-[#0d0d0d]">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 justify-items-center">
        {skills.map((skill, idx) => (
          ...
          >
            <div className="text-teal-300">{skill.icon}</div>
